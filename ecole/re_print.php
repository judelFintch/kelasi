...
<!--formulaire enregistrement frais hors systeme -->
	  <div class="row">
			 <div class="col-lg-4">
			     ...
			     <input type="text" name="codeFacture" required="" placeholder="Recherche dans autres" class="form-control search_oder_frais" name="">
			     </div>	  
			 </div>	
		 ...
		 echo' 
           <div id="div1" > 
              <div class="facture">
                   ...
                   <tr>
                      <td><center> <b class="codefacture">'.$_POST['codeFacture'].'</b></center></td>
                      </tr>
                   <tr>
