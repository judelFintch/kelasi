...
<input type="text" class="form-control postnom" size="45" value=""  placeholder="Postnom"  required/></p>
<p>
...
<input type="button" class="pull-right btn btn-success btnValidation" value="Enregistrer" />
				<p>
				<input type="reset" class="pull-right btn btn-danger" value="Effacer" /></p>
</div>
</div>
